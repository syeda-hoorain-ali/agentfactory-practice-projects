...
Reused unchanged from Project 03. Project 07 does not sabotage this file —
it sabotages the skill's *instruction* to use it (see the sabotaged skill's
step 2). This script stays the working, trustworthy version, so you have
a known-good baseline to diagnose against.
