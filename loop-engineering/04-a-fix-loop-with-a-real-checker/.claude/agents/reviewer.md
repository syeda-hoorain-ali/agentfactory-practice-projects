---
name: reviewer
description: Reviews a diff (scoped to loop-engineering/04-a-fix-loop-with-a-real-checker/) against the failing test. Replies PASS or FAIL with reasons. Makes no changes.
tools: Read, Bash
